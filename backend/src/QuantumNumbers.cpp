...
const char * Handedness::Names [] = { "l", "r", "NoHandedness", 0 };
const char * Type::Names [] = { "Fermion", "Boson", 0 };

std::pair<QuantumNumber::aQuantumNumber,QuantumNumber::uQuantumNumber> QuantumNumber::GetFromString( char cData ) {
